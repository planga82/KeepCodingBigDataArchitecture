...
sqoop import --connect jdbc:mysql://172.17.0.1/ODS --driver com.mysql.jdbc.Driver --username load --password loadpwd --table TMP_CLIENTES_FILTRO --target-dir /kcbda/ODS_HC_CLIENTES -m 1
